...
public class RSPageAttributeAffiliation {
	...
	public void addRSPageAttributeAffiliation(RSPageAttributeAffiliation rspaa) {
		RSPageAttributeAffiliationDAO.addPageAttributeAffiliation(rspaa);
	}
	
	public void addRSPageAttributeAffiliation(int RSPageId, int RSAttributeId, 
		...
		rspaa.addRSPageAttributeAffiliation(rspaa);
	}
